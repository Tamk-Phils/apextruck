...
export default function NewPartPage() {
    ...
    const [form, setForm] = useState({
        name: "", model_year: "", category: "performance", price: "", status: "available", description: "",
    });
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <header className="mb-12">
                    <h1 className="font-display text-4xl sm:text-6xl font-black text-surface-50 uppercase tracking-tighter">
                        ADD <span className="text-amber-500">NEW PART.</span>
                    </h1>
                    <p className="text-surface-200/40 text-[10px] font-black uppercase tracking-[0.2em] mt-3">
                        Enter part details and stock status
                    </p>
                </header>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="bg-charcoal-800 border border-surface-200/5 rounded-[40px] p-10 shadow-2xl space-y-8">
                        <div className="grid sm:grid-cols-2 gap-8">
                            {[
                                { field: "name", label: "Part Name", type: "text", placeholder: "e.g. Heavy Duty Flatbed" },
                                { field: "model_year", label: "Year / Series", type: "text", placeholder: "e.g. 2024 Series" },
                                { field: "price", label: "Price ($)", type: "number", placeholder: "0.00" },
                                ...
                                <div key={field}>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-6 py-4 bg-charcoal-900 border border-surface-200/5 rounded-2xl text-sm text-surface-50 focus:outline-none focus:border-amber-500/50 transition-all placeholder:text-surface-200/10"
                                    />
                                </div>
                            ))}
                            <div>
                                <label className="block text-[10px] font-black text-surface-200/40 uppercase tracking-[0.2em] mb-3">Category</label>
                                <select
                                    value={form.category}
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    {[
                                        { id: "available", label: "In Stock", color: "text-emerald-600" },
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Detail the component specifications, material quality, and compatibility…"
                                className="w-full px-6 py-4 bg-charcoal-900 border border-surface-200/5 rounded-2xl text-sm text-surface-50 placeholder:text-surface-200/10 focus:outline-none focus:border-amber-500/50 transition-all resize-none font-medium leading-relaxed"
                            />
                        </div>
                    </div>
                    ...
                    <div className="bg-charcoal-800 border border-surface-200/5 rounded-[40px] p-10 shadow-2xl">
                        <h2 className="text-[10px] font-black text-surface-200/40 uppercase tracking-[0.3em] mb-6 text-center">Images</h2>
                        <label className="cursor-pointer flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-surface-200/10 rounded-[32px] hover:border-amber-500/30 hover:bg-white transition-all group">
                            <Upload className="w-8 h-8 text-surface-200/20 group-hover:text-amber-500 mb-4 transition-colors" />
                            <span className="text-[10px] font-black text-surface-200/40 uppercase tracking-widest group-hover:text-surface-50 transition-colors">
